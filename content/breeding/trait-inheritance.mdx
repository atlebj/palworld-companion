...
- [Now find the species path](#now-find-the-species-path)
- [Common mistakes](#common-mistakes)

---

![Breeding Trait Inheritance](/images/trait-inheritance.svg)
...
Trait inheritance tells you **which passives** transfer. It doesn't tell you **which pal species** you'll get from a given pair — that's a separate lookup.

Once your trait plan is set, use these to figure out the species side:

- **[Breeding Pathfinder](/calculators/breeding)** — given the Pals you already own, find the shortest chain to the species you want.
- **[Breeding Simulator](/calculators/breeding-simulator)** — pick any two parents to see the offspring, or pick a target child to see every pair that produces it.

Both run against a documented dataset of 9,400+ parent pairs, so the species predictions match what the game actually rolls.
