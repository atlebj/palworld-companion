...
## On this page
- [What passive skills are](#what-passive-skills-are)
- [The 3 build types you should use](#the-3-build-types-you-should-use)
- [How to evaluate a passive quickly](#how-to-evaluate-a-passive-quickly-rule-of-thumb)
- [Why clean lines matter](#clean-lines-matter-more-than-perfect-luck)
- [Suggested passive sets](#suggested-passive-sets-practical-starter-templates)
- [Common mistakes](#common-mistakes-and-what-to-do-instead)
- [Quick breeding checklist](#quick-checklist-before-you-lock-a-breeding-parent)
