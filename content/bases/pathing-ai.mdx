...
## On this page
- [The core idea: simple AI rules](#the-core-idea-pals-follow-simple-rules)
- [Why Pals get stuck or wander](#why-pals-get-stuck-or-wander)
- [Pathing-friendly base design principles](#pathing-friendly-base-design-principles)
- [How AI task switching hurts you](#how-ai-task-switching-hurts-you)
- [Common AI-related mistakes](#common-ai-related-mistakes)
- [A simple troubleshooting checklist](#a-simple-troubleshooting-checklist)
- [When AI problems are unavoidable](#when-ai-problems-are-unavoidable)
- [How this ties everything together](#how-this-ties-everything-together)
...
> Related foundation: [Worker roles explained](/bases/worker-roles)
