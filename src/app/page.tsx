...
export default function Home() {
  return (
    <div className="max-w-5xl mx-auto py-16 px-4 sm:px-6">
      <div className="mb-8 rounded-lg border border-[var(--color-brand-border)] bg-[var(--color-brand-surface)] px-4 py-3 text-sm font-semibold text-[var(--color-brand-text-primary)]">
        Hello world
      </div>
