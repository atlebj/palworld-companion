...
export default function CaptureChanceClient() {
  ...
  // Load from URL once
  useEffect(() => {
    setHp(clamp(numFromParam(searchParams.get("hp"), 30), 1, 100));
  ...
  return (
    <div className="max-w-3xl">
      ...
      <p className="opacity-80 mb-6">
        A <strong>decision helper</strong>, not an exact probability calculator. It scores your attempt quality and suggests improvements.
      </p>
