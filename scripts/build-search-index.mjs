...
const STATIC_ROUTES = [
  ...
  { type: 'tool',  slug: '/calculators/iv',                    title: 'IV Calculator',                 description: 'Estimate hidden Individual Values from observed stats.' },
  ...
  { type: 'tool',  slug: '/calculators/base-efficiency',       title: 'Base Efficiency Dashboard',     description: 'Plan workforce and forecast resource output.' },
